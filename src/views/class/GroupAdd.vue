                        ...
                        <AccordionContent>
                            <div class=" flex flex-col gap-4 w-full">
                                ...
                                <div class="flex flex-col md:flex-row">
                                    <div class="flex flex-wrap gap-2 w-full">
                                        <small v-if="errors.className" class="text-red-600"> {{ errors.className
                                            }}</small>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full">
                                ...
                                <div class="flex flex-col md:flex-row ">
                                    <div class="flex flex-wrap gap-2 w-full">
                                        <small v-if="errors.formatType" class="text-red-600"> {{ errors.formatType
                                            }}</small>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full ">
                                ...
                                <div class="flex flex-col md:flex-row gap-4 ">
                                    <div class="flex flex-wrap gap-2 w-full">
                                        ...
                                        <Select id="Site" v-model="site" :options="siteOptions"
                                                class="w-full" optionLabel="siteName" placeholder="Select One"
                                    ...
                                    <div class="flex flex-wrap gap-2 w-full">
                                        ...
                                        <Select id="Location" v-model="location" :options="locationOptions"
                                                class="w-full" optionLabel="locationName"
                                                placeholder="Select One"></Select>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full">
                                        ...
                                        <Select id="Scope" v-model="scope" :options="scopeOptions"
                                                class="w-full" optionLabel="scopeName"
                                                placeholder="Select One"></Select>
                                    </div>
                                </div>
                                <div class="flex flex-col md:flex-row ">
                                    ...
                                    <div class="flex flex-wrap gap-2 w-full">
                                        <small v-if="errors.location" class="text-red-600 ml-2"> {{ errors.location
                                            }}</small>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full">
                                ...
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="flex flex-wrap gap-2 w-full">
                                        ...
                                        <InputNumber v-model="planRevenue" :max="99999999999999" :min="0" mode="decimal"
                                                     showButtons>
                                        </InputNumber>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full">
                                ...
                                <div class="flex flex-col md:flex-row ">
                                    ...
                                    <div class="flex flex-wrap gap-2 w-full">
                                        <small v-if="errors.planRevenue" class="text-red-600 ml-2"> {{
                                                errors.planRevenue }}</small>
                                    </div>
                                    <div class="flex flex-wrap gap-2 w-full">
                                        <small v-if="errors.keyProgram" class="text-red-600 ml-2"> {{ errors.keyProgram
                                            }}</small>
                                    </div>
                                </div>
                                <div class="flex flex-col md:flex-row gap-4">
